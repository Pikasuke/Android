package com.example.newslaterapp.Model;
...
public class Source {
    ...
    public Source(String id, String name, String description, String url, String category, String langage, String country, UrlsToLogos urlsToLogos, List<String> sortByAvailable) {
        this.id = id;
        this.name = name;
